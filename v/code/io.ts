...
export interface anchor {
    ...
    //up this io. Tyically it is a td, but we have generalised in preparation
    //for ios that are not laid out in a tabbular fashion, i.e., the label
    //layout
    element:HTMLElement,
    //
...
export abstract class io extends view.view{
    ...
    //
    //In a complex io, i.e,, one which as more input element, the proxy is an
    //HTML input element that receives the listerner events on behalf of the 
    //others. See the use case in automatic saving of data onblur event 
    //(under tabulation) 
    get proxy(): HTMLInputElement|HTMLSelectElement|undefined{
        //
        //In complex ios it is not clear which of the multiple inpus is the most
        //suitable to be  the represantive input. In this case we return undefined
    ...
    static get_io_type(anchor:anchor, type?:io_type, options?:Partial<options>):io_type|io{
        //
    ...
    static deduce_io(
        ...
        if (col instanceof schema.foreign) 
            return new foreign(anchor, undefined, {col});
        //
    ...
    get_label_layout(alias:Array<schema.basic_value>=[]):quest.label{
        ...
        const col:schema.column|undefined = this.options?.col; 
        //
...
export class select extends io{
    ...
    get proxy():HTMLSelectElement{return this.input}
...
export class url extends io{
    ...
    get proxy():HTMLInputElement{return this.text}
    // 
    constructor(anchor:anchor, options?:Partial<options>) {
...
export class foreign extends io{
    ...
    get proxy():HTMLInputElement{return this.button}
...
export class input extends io{
    ...
    get proxy():HTMLInputElement{return this.input}
    //
    constructor(
        //
        ...
        this.input = this.create_element("input", anchor.element, {
           ...
           size:typeof input_type==='object' ? input_type.size: undefined,
           //
           //Set the maximum length, for texts only
           maxlength: typeof input_type==='object' ? input_type.maxlength: undefined
       });
    }
...
export class textarea extends input{
    ...
    //
    constructor(anchor:anchor, size?:number, options?:Partial<options>) {
        //
