...
export class path{
    ...
    //The server will prepend  $_SERVER['DOCUMENT_ROOOT'] to derive the full
    //physical address of the path, e.g., d:/mutall_projects/chama/v/code/xyz.php
    //If the prepending is not necessary, set add_root to false
    //We also need to know if its a file or not 
    constructor(path:path, is_file:boolean, add_root:boolean);
